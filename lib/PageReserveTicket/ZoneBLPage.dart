...
class ZoneBLPage extends StatefulWidget {
  const ZoneBLPage({super.key});

  @override
  State<ZoneBLPage> createState() => _ZoneBLPageState();
}

class _ZoneBLPageState extends State<ZoneBLPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('เลือกที่นั่งในโซน BL'),
