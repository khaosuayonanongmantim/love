...
class ZoneVIPPage extends StatefulWidget {
  const ZoneVIPPage({super.key});

  @override
  State<ZoneVIPPage> createState() => _ZoneVIPPageState();
}

class _ZoneVIPPageState extends State<ZoneVIPPage> {
  Set<int> selectedSeats = Set();
  Set<int> bookedSeats = Set(); // Set to keep track of booked seats
  static const double seatPrice = 6500.0;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('เลือกที่นั่งในโซน VIP'),
